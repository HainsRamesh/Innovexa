...
// Strict validation schema for publishing - ALL fields required
...
// Relaxed schema for draft (only title required)
const draftSchema = z.object({
  title: z.string().min(1, 'Title is required for draft').max(120),
  description: z.string().max(5000).optional(),
  category: z.enum(['technology', 'healthcare', 'sustainability', 'finance', 'education', 'infrastructure', 'manufacturing', 'agriculture', 'other'] as const).optional(),
    ...
    try {
      ...
      setTimeout(() => {
        ...
        toast({
          ...
          description:
            status === 'draft'
              ? 'Your problem has been saved as a draft. Complete all required fields to publish.'
