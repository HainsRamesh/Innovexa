      ...
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-32 overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold mb-6 leading-tight animate-fade-in" style={{ animationDelay: '0.1s' }}>
              Where Real Problems
              <br />
            ...
            <p className="text-lg sm:text-xl text-muted-foreground mb-10 max-w-2xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
              INNOVEXA connects enterprises with global innovators to solve real-world challenges.
              AI-powered matching, evaluation, and discovery for breakthrough results.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            {categories.map((category) => (
              <Badge key={category.name} variant={category.color} className="cursor-pointer hover:opacity-80 transition-opacity">
                {category.name}
              </Badge>
            ))}
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Our platform leverages artificial intelligence to simplify, evaluate, match,
              and rank solutions—helping you discover innovations based on value, not marketing.
            </p>
          </div>
      ...
      <section className="py-20 lg:py-32 bg-secondary/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Whether you're posting challenges, submitting solutions, or discovering investments—
              INNOVEXA provides the tools you need.
            </p>
          </div>
          ...
          <Card variant="highlight" className="max-w-4xl mx-auto overflow-hidden">
            <CardContent className="p-8 lg:p-12 text-center">
              ...
              <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
                Join thousands of organizations and innovators already using INNOVEXA
