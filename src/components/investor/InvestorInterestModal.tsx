...
export function InvestorInterestModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="sm:max-w-md p-0 gap-0 flex flex-col max-h-[90vh] sm:max-h-[80vh]"
      >
        {/* Fixed Header */}
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-1 min-h-0">
            ...
            {/* Sticky Footer */}
            <div className="flex gap-3 p-4 border-t border-border/50 bg-background flex-shrink-0">
              <Button
                type="button"
                variant="outline"
